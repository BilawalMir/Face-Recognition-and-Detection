...
face_classifier = cv2.CascadeClassifier(
    "/haarcascade_frontalface_default.xmll"   # paste your path 
)
directory_path = "/database"      # your Path
faces_dict = {}
count = 0

for filename in os.listdir(directory_path):
    if filename.lower().endswith((".png", ".jpg", ".jpeg", ".tiff", ".bmp", ".gif")):
        person_name = os.path.splitext(filename)[
            0
        ]  # Remove the file extension to get the person's name
            ...
            try:
                ...
                if result[0]:
                    ...
                    cv2.rectangle(
                        live,
                        (bg_x, bg_y),
                        (bg_x + text_size[0], bg_y + text_size[1] + 5),
                        (0, 0, 0),
                        -1,
                    )
